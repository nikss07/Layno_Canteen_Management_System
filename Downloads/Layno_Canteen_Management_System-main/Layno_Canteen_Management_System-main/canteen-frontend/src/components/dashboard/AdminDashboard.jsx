...
function StatCard({ icon, label, key: _k, format, sub, color, bg, border, trend, trendUp, value, delay }) {
  return (
    <div
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    orderService.getSalesReport()
      ...
      .catch(() => setStats({ total_sales: 0, total_orders: 0, avg_order_value: 0, today_orders: 0 }))
